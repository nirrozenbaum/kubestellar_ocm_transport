...
require (
	github.com/kubestellar/kubestellar v0.2.3-0.20240101112417-7d988b9132f3
...
require (
	...
	github.com/kcp-dev/kcp v0.11.0 // indirect
	github.com/kcp-dev/kcp/pkg/apis v0.11.0 // indirect
	github.com/kcp-dev/logicalcluster/v3 v3.0.2 // indirect
	github.com/kubestellar/kubestellar/space-framework v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/kubestellar/kubestellar => ../kubestellar/
	github.com/kubestellar/kubestellar/space-framework => ../kubestellar/space-framework
	// kcp related
